...
//       const { userEmail, timestamp, functionName, startDate, endDate, limit } = req.query;

//       // בניית אובייקט פילטרים
//       const filters = {
//         userEmail: userEmail as string,
//         timestamp: timestamp as DateISO,
//         functionName: functionName as string, 
//         startDate: startDate as string,
//         endDate: endDate as string,
//         limit: limit ? parseInt(limit as string) : 50, // אם לא ניתן מגבלה, תשתמש ב-50 כערך ברירת מחדל
//       };
