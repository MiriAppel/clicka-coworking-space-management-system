...
import { ExpenseCategory, ExpenseStatus, ExpensePaymentMethod } from "shared-types";
const mockExpense: Expense = {
  ...
  reference: 'INV-1001',
  invoice_number: '1001',
  // invoiceFile: { name: 'invoice.pdf', url: '/files/invoice.pdf' },
  // receiptFile: { name: 'receipt.pdf', url: '/files/receipt.pdf' },
  notes: 'Urgent',
  // approved_by: null,
  // approved_at: null,
