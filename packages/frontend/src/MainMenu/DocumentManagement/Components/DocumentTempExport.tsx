...
export const DocumentTemplatePreviewPage: React.FC = () => {
  ...
  const { getDocumentTemplateById, currentDocumentTemplate, loading, error, setCurrentDocumentTemplate } = useDocumentTemplateStore();
  ...
  const exportToPDF = async () => {
    ...
    // const pageHeight = pdf.internal.pageSize.getHeight(); // removed unused variable
