...
{formatDate(currentDocumentTemplate.updatedAt)}</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className={`font-medium ${
                  currentDocumentTemplate.active ? 'text-green-600' : 'text-red-600'
                }`}>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className={`font-medium ${
                  currentDocumentTemplate.isDefault ? 'text-blue-600' : 'text-gray-600'
                }`}>
