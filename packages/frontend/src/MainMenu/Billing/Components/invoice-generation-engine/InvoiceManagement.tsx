...
const invoiceData = {
  ...
  taxtotal: taxAmount, // ייתכן ששני השדות הללו מיותרים — תבחרי אחד לפי המודל
...
function useInvoiceStore(): { invoices: any; loading: any; error: any; fetchInvoices: any; createInvoice: any; updateInvoiceStatus: any; deleteInvoice: any; } {
