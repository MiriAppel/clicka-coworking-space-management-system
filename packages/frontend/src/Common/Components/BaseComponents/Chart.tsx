      ...
      <div ref={chartRef}>
        <ResponsiveContainer width="100%" height={300}>
          ...
          {type === 'line' ? (
            ...
            <PieChart>
              <Tooltip />
              <Legend wrapperStyle={{ fontSize: '12px', padding: 30 }} /> {/* שינוי גודל ה-Legend לרספונסיבי */}
              <Pie
                data={data}
                dataKey="value"
                nameKey="label"
                ...
                //   const radius = outerRadius + 20; // המרחק מהתרשים
                //   const x = cx + radius * Math.cos(-midAngle * Math.PI / 180);
                //   const y = cy + radius * Math.sin(-midAngle * Math.PI / 180);
                //   const fillColor = COLORS[index % COLORS.length]; // צבע הפרוסה
                //   return (
